...
//   setWorkPreference: (preference: WorkPreference | null) => void
...
//   addSkill: (skill) =>
//     set((state) => {
//       if (state.skills.includes(skill) || state.skills.length >= 15)
//         return state
...
//   addTool: (tool) =>
//     set((state) => {
//       if (state.tools.includes(tool) || state.tools.length >= 15)
//         return state
...
//       )
//         return state
//       return { technologies: [...state.technologies, tech] }
//     }),
